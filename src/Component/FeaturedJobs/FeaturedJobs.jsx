  ...
  return (
    <div className="mt-36 relative">
      ...
      <div className="grid grid-cols-2 gap-8 mt-20">
        {jobFeatures.length && jobFeatures.slice(0, 4).map((feature) => (
          <SingleFeature key={feature.id} feature={feature}></SingleFeature>
        ))}
      </div>
      <button className="btn bg-gradient-to-r from-indigo-400 to-violet-500 px-2 py-2 text-white rounded-md font-medium mt-10   absolute -bottom-16 left-[46%]">
        See All Jobs
      </button>
    </div>
  );
